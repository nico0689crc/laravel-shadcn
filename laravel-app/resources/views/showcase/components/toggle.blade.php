...
<div class="mx-auto max-w-[--container-md] px-4 sm:px-6 lg:px-8 py-10 space-y-12">
    ...
    <div>
        <h1 class="text-3xl font-bold tracking-tight">Toggle / Toggle Group</h1>
        <p class="mt-1 text-muted-foreground max-w-prose">Botón de dos estados (on/off). Toggle Group gestiona la selección entre múltiples opciones con tipo <code class="text-xs bg-muted px-1 rounded">single</code> o <code class="text-xs bg-muted px-1 rounded">multiple</code>.</p>
    </div>

    {{-- Toggle default --}}
    <section class="space-y-4">
        <h2 class="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Toggle</h2>
    ...
    {{-- Toggle Group single --}}
    <section class="space-y-4">
        <h2 class="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Toggle Group — single</h2>
        <div class="space-y-3">
    ...
    <section class="space-y-4">
        <h2 class="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Toggle Group — multiple</h2>
